...
public class PathsBlue {
    ...
    final Pose shootingPose = new Pose(43, 100, Math.toRadians(139));

    final Pose PPG = new Pose(100, 83, Math.toRadians(0)).mirror();
    final Pose PGP = new Pose(100, 59, Math.toRadians(0)).mirror();
    final Pose GPP = new Pose(100, 36, Math.toRadians(0)).mirror();

    final Pose IntakePPG = new Pose(120, 83, Math.toRadians(0)).mirror();
    final Pose IntakePGP = new Pose(128, 59, Math.toRadians(0)).mirror();
    final Pose IntakeGPP = new Pose(125, 36, Math.toRadians(0)).mirror();
    final Pose Gate      = new Pose(12, 70.5, Math.toRadians(180));
    ...
    public PathsBlue(Follower follower)
    {
        ...
        openGate = follower.pathBuilder()
                .addPath(new BezierCurve(IntakePGP, new Pose(95, 65).mirror(), Gate))
