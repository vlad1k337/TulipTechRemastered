...
public class LimelightSubsystem {
    ...
    public void positionFromTag(double heading, TelemetryManager telemetry)
    {
        ...
        if(result != null && result.isValid()) {
            ...
            if (botpose != null) {
                ...
                telemetry.addData("MT Pedro X", botposePedro.getX());
                telemetry.addData("MT Pedro Y", botposePedro.getY());

                LimelightSubsystem.fusionLocalizer.addMeasurement(botposePedro, System.nanoTime() - result.getStaleness());
            }
        }
    }
